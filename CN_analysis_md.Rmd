...
```{r all_plots, echo=FALSE, message=FALSE, fig.width=7,results = "asis", dpi=300}
for (i in Output_types) {
  ...
  g_grid <- grid.arrange(g_co2perha, g_co2perkg, g_Nsurplus, g_NUE,
                         ...
                         bottom=textGrob("   Results are shown for the average (median) farm.\nError bars demonstrate the spread of data from the lower to upper quartile.", gp=gpar(fontsize=13,font=1),x=0,hjust=-0.08))
